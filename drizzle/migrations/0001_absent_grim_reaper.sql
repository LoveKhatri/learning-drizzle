...
ALTER TABLE "user" ADD COLUMN "userRole" "user_role" DEFAULT 'BASIC' NOT NULL;--> statement-breakpoint
DO $$ BEGIN
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "email_index" ON "user" USING btree ("email");--> statement-breakpoint
ALTER TABLE "user" ADD CONSTRAINT "user_email_unique" UNIQUE("email");--> statement-breakpoint
ALTER TABLE "user" ADD CONSTRAINT "unique_name_and_age" UNIQUE("name","age");